...
func NewRedisReposiroty(redisURL string) (shortener.RedirectRepository, error){
...
func (r *redisRepository) Find(code string) (*shortener.Redirect, error) {
	...
	if len(data) == 0{
		return nil, errors.Wrap(shortener.ErrRirectNotFound, "repository.Redirect.Find")
	}
...
func (r *redisRepository) Store(redirect *shortener.Redirect) error {
	...
	if err != nil {
		return errors.Wrap(err, "Shortener.Redirect.Store")
	}
	return nil
}
